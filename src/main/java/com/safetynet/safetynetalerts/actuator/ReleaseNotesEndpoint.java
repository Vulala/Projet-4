...
public class ReleaseNotesEndpoint {
	...
	/**
	 * {@link ReleaseNotesEndpoint} is a self construct actuator, permitting an
	 * access to the different versions of the application.
	 */
	...
	String version1_3 = "Version 1.3 \n\n" + "-Endpoints CRUD added\n" + "-So are the tests related to them\n"
			+ "-Add of Javadocs and comments for the entire application\n\n";
	String version1_4 = "Version 1.4 \n\n" + "-Endpoints URLs added\n" + "-So are the tests related to them\n\n";
