...
#/firestation?stationNumber=<station_number>
  ...
  Scenario: The </firestation?stationNumber> is used to GET the list of the people covered by the <stationNumber> set as parameter
    ...
    And It show me a count of the numbers of adults and children (-18yo) deserved by the <stationNumber>

#/childAlert?address=<address>
  @/childAlert?address
  Scenario: The </childAlert> is used to GET the list of the children (-18yo) living at the <address> set as parameter
...
#/phoneAlert?firestation=<firestation_number>
  ...
  Scenario: The </phoneAlert> is used to GET all the phone numbers of the people covered by the station set as parameter
...
#/fire?address=<address>
  @/fire?address
  Scenario: The </fire> is used to GET the list of the people living at the <address> set as parameter plus the <station_number> who deserve this <address>
